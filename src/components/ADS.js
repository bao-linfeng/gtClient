...
var getLocalTime=function (nS,symbol,index) {
    var date=new Date(nS),Y,M,D,h,m,s;
...
var updateMap=function(data,map,infoWindow,AMap){
    map.clearMap();
    var datas=data,marker,markers=[],cluster;
...
export  {getLocalTime,getCharLength,substrAndReplaceToEllipsis,getJSON,postJSON,GetRandomNum,updateMap,switchType};