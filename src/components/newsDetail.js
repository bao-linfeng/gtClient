...
class NewsDetail extends Component {
    ...
    render() {
        ...
        return (
            <div className="consultationDetail" onLoad={(e)=>{store.dispatch(setPathname('/news'))}}>
                <Header />
                {
                    consultationDetail ? 
                ...
                <div className="expert_answer w_1170">
                    {
                        ...
                        <div className='action_view'>
                            ...
                            <Icon type={islike ? 'like' : 'like-o'} onClick={(e)=>this.handleClickHabit(e,2,'like','news')} style={{margin:'0 5px 0 20px',color:'orange',cursor:'pointer'}} />{likeCount}赞
                            <Icon type={iscollect ? 'heart' : 'heart-o'} onClick={(e)=>this.handleClickHabit(e,2,'collect','news')} style={{margin:'0 5px 0 20px',color:'#f00',cursor:'pointer'}} />{collectCount}收藏
                        </div> : null
                    }
                </div>
                <Footer />
